...
class Auth extends Controller
{
	...
	function login()
	{
			...
			else
			{
				...
				{						
					...
					//$this->load->view($this->dx_auth->login_view, $data);
                                        $data['view_name'] = $this->dx_auth->login_view;
                                        $this->load->view("admin/common/template_login", $data);
		...
		else
		{
			$data['auth_message'] = 'You are already logged in.';
                        ...
                        $data['view_name'] = $this->dx_auth->logged_in_view;
	...
	function logout()
	{
		...
		$data['auth_message'] = 'You have been logged out.';
                ...
                $data['view_name'] = $this->dx_auth->logout_view;
                $this->load->view("admin/common/template_login", $data);
	...
	function forgot_password()
	{
		...
		if ($val->run() AND $this->dx_auth->forgot_password($val->set_value('login')))
		{
			...
			//$this->load->view($this->dx_auth->forgot_password_success_view, $data);
                        ...
                        $data['view_name'] = $this->dx_auth->forgot_password_success_view;
                        $this->load->view("admin/common/template_login", $data);
		...
		else
		{
			//$this->load->view($this->dx_auth->forgot_password_view);
                        ...
                        $data['view_name'] = $this->dx_auth->forgot_password_view;
                        $this->load->view("admin/common/template_login", $data);
	...
	function reset_password()
	{
		...
		if ($this->dx_auth->reset_password($username, $key))
		{
			...
			//$this->load->view($this->dx_auth->reset_password_success_view, $data);
                        ...
                        $data['view_name'] = $this->dx_auth->reset_password_success_view;
                        $this->load->view("admin/common/template_login", $data);
		}
		else
		{
			...
			//$this->load->view($this->dx_auth->reset_password_failed_view, $data);
                        ...
                        $data['view_name'] = $this->dx_auth->reset_password_failed_view;
                        $this->load->view("admin/common/template_login", $data);
		...
		{			
			...
			if ($val->run() AND $this->dx_auth->change_password($val->set_value('old_password'), $val->set_value('new_password')))
			{
				...
				//$this->load->view($this->dx_auth->change_password_success_view, $data);
                                $data['view_name'] = $this->dx_auth->change_password_success_view;
                                $this->load->view("admin/common/template", $data);
			...
			else
			{
				//$this->load->view($this->dx_auth->change_password_view);
                                $data['view_name'] = $this->dx_auth->change_password_view;
                                $this->load->view("admin/common/template", $data);

...
<form id='editForm' method='post' onSubmit="if(confirm('Continue to add?')) return ture; else return false" action='<?php echo base_url() . "admin/support_list/add_submit/"; ?>' >
    <div id="tab_data" style="display:block">
            ...
            <table class="form">
                ...
                <tr>
                    <td>Description:</td>
                    <td><textarea name='description' id='description' value="" class="full"></textarea>
                    <?php
               ...
               <tr>
                    ...
                    <td><input name='file1' id='file1'  value='' />
                        <div>
                        <input type="button"
                               value="Insert PDF"
               ...
               <tr>
                    ...
                    <td><input name='file2' id='file2'  value='' />
                        <div>
                        <input type="button"
                               value="Insert PDF"

...
<a href="<?php echo base_url() . 'admin/category_list/'; ?>" >view category list</a>
  ...
  <form id='editForm' method='post' onSubmit="if(confirm('Continue to add?')) return ture; else return false"action='<?php echo base_url() . "admin/category_list/add_submit/"; ?>' >
    <div id="tab_data" style="deisplay:block">
            ...
            <table class="form">
                <tr>
                    ...
                    <td>
                        <div>
                        <input name='banner' id='banner' value=''/>
                        </div>
                        <div>
                        <img width="150" name='bannerview' id='bannerview' alt="" src=''/>
                        </div>
                        <div>
                        <input type="button"

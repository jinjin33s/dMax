...
<a href="<?php echo base_url() . 'admin/s_category_list/'; ?>" >view category list</a>
  ...
  <form id='editForm' method='post' onSubmit="if(confirm('Continue to edit?')) return ture; else return false" action='<?php echo base_url() . "admin/s_category_list/update_submit/" . $categoryList->id; ?>' >
                ...
                <tr>
                    ...
                    <td>
                        <select name="category" id="category">
                            <?php
                                foreach ($category as $cgl) {
                                    if (strcmp($categoryList->category_id, $cgl->id) == 0)
